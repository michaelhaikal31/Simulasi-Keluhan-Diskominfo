package com.goblog.androidhive.activity;
...
import com.goblog.androidhive.Fragment.DialogKeluhan;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button saveBtn, cameraBtn;
    private RecyclerView rv;
    private FireBaseClient fireBaseClient;
    final static String DB_URL = "https://androidhive-bf05b.firebaseio.com/";
    DialogKeluhan dialogKeluhan = new DialogKeluhan();
    ...
    /*private void displayDialog()
    {
        ...
        cameraBtn = (Button)d.findViewById(R.id.btn_camera);
